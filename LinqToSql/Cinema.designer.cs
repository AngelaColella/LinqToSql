...
namespace LinqToSql
{
    ...
    partial void DeleteSale(Sale instance);
		...
		public System.Data.Linq.Table<Prenotazione> Prenotaziones
		{
			get
			{
	...
	public partial class Prenotazione : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _NumeroPosti;
    ...
    partial void OnNumeroPostiChanging(System.Nullable<int> value);
    partial void OnNumeroPostiChanged();
    ...
    partial void OnMailChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NumeroPosti", DbType="Int")]
		public System.Nullable<int> NumeroPosti
		{
			get
			{
				return this._NumeroPosti;
			}
			set
			{
				if ((this._NumeroPosti != value))
				{
					this.OnNumeroPostiChanging(value);
					this.SendPropertyChanging();
					this._NumeroPosti = value;
					this.SendPropertyChanged("NumeroPosti");
					this.OnNumeroPostiChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Programmazione_Prenotazione", Storage="_Programmazione", ThisKey="ProgrammazioneID", OtherKey="ID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Programmazione.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Prenotaziones.Remove(this);
					}
					this._Programmazione.Entity = value;
					if ((value != null))
					{
						value.Prenotaziones.Add(this);
	...
	public partial class Programmazione : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Prenotazione> _Prenotaziones;
    ...
    partial void OnPosti_DisponibiliChanged();
		...
		{
			this._Prenotaziones = new EntitySet<Prenotazione>(new Action<Prenotazione>(this.attach_Prenotaziones), new Action<Prenotazione>(this.detach_Prenotaziones));
			this._Movy = default(EntityRef<Movy>);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Programmazione_Prenotazione", Storage="_Prenotaziones", ThisKey="ID", OtherKey="ProgrammazioneID")]
		public EntitySet<Prenotazione> Prenotaziones
		{
			get
			{
				return this._Prenotaziones;
			}
			set
			{
				this._Prenotaziones.Assign(value);
			}
		}
		...
		private void attach_Prenotaziones(Prenotazione entity)
		{
			this.SendPropertyChanging();
